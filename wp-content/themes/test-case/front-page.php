...
?>
						...
						<div class="row h-100 align-items-center">
							...
							<div class="col-12 col-md-6">
								<div class="welcome-thumbnail">
									<img src="<?php echo get_template_directory_uri()?>/img/bg-img/1.png" alt="" data-animation="slideInRight" data-delay="400ms">
								</div>
							</div>
						</div>
					</div>
	...
	<section class="uza-about-us-area">
		...
		<div class="about-bg-pattern">
			<img src="<?php echo get_template_directory_uri()?>/img/core-img/curve-2.png" alt="">
		</div>
	</section>
	...
	<section class="uza-portfolio-area section-padding-80">
			...
			<div class="row">
				...
				<div class="portfolio-sildes owl-carousel">
					...
					<div class="single-portfolio-slide">
						<img src="<?php echo get_template_directory_uri()?>/img/bg-img/3.jpg" alt="">
						<!-- Overlay Effect -->
					...
					<div class="col-12">
						...
						<div class="testimonial-slides owl-carousel">
							...
							<div class="single-testimonial-slide d-flex align-items-center">
								<!-- Testimonial Thumbnail -->
								<div class="testimonial-thumbnail">
									<img src="<?php echo get_template_directory_uri()?>/img/bg-img/23.jpg" alt="">
								</div>
								<!-- Testimonial Content -->
								<div class="testimonial-content">
									<h4>“Colorlib Ltd’s ranking has gone up so much from the great work that your team has done and our brand get organic sales consistently from your efforts. We are happy that the results of your efforts were lasting and profitable.”</h4>
							...
							<div class="single-testimonial-slide d-flex align-items-center">
								<!-- Testimonial Thumbnail -->
								<div class="testimonial-thumbnail">
									<img src="<?php echo get_template_directory_uri()?>/img/bg-img/24.jpg" alt="">
								</div>
								<!-- Testimonial Content -->
								<div class="testimonial-content">
									<h4>“Colorlib Ltd’s ranking has gone up so much from the great work that your team has done and our brand get organic sales consistently from your efforts. We are happy that the results of your efforts were lasting and profitable.”</h4>
		...
		<div class="portfolio-bg-curve">
			<img src="<?php echo get_template_directory_uri()?>/img/core-img/curve-3.png" alt="">
		</div>
	</section>
	...
	<section class="uza-blog-area">
		...
		<div class="blog-bg-curve">
			<img src="<?php echo get_template_directory_uri()?>/img/core-img/curve-4.png" alt="">
		</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<!-- Single Blog Post -->
				<div class="col-12 col-lg-4">
					<div class="single-blog-post bg-img mb-80" style="background-image: url(<?php echo get_template_directory_uri()?>/img/bg-img/8.jpg);">
						<!-- Post Content -->
				...
				<!-- Single Blog Post -->
				<div class="col-12 col-lg-4">
					<div class="single-blog-post bg-img mb-80" style="background-image: url(<?php echo get_template_directory_uri()?>/img/bg-img/9.jpg);">
						<!-- Post Content -->
						<div class="post-content">
				...
				<!-- Single Blog Post -->
				<div class="col-12 col-lg-4">
					<div class="single-blog-post bg-img mb-80" style="background-image: url(<?php echo get_template_directory_uri()?>/img/bg-img/10.jpg);">
						<!-- Post Content -->
						<div class="post-content">
...
<?php
//get_template_part( 'template-parts/first-screen','first-screen', ['data' => $screens] );
